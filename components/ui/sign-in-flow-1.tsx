                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Chris Alpuerto</h1>
                      <p className="text-[1.8rem] text-white/70 font-light">Backend / DevOps / Cloud Engineer</p>
                    </div>
